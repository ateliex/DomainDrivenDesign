...
{
    public class ItensDePlanoComercialObservableCollection : ViewModelCollection<ItemDePlanoComercialViewModel>
    {
        ...
        {
            var contains = planoComercial.model.ExisteItemDoModelo(modelo.GetModel());
